...
# Three lines of code.
    revisedWords = []
    for word in words:
        revisedWords.append(word.translate(str.maketrans('', '', string.punctuation)))
...
# depends on your coding style -- various styles are OK.)
    ...
    for word in wordList:
        count+=revisedWords.count(word.lower())
...
# differently?
'''
The results do show that Poe and Neruda use 'a' and 'an' differently.
Poe uses 'an' and 'a' more frequently than Neruda. Based on the results, Poe also
uses 'the' more often than Neruda. Both Poe and Neruda use 'the' more often than 'a' and 'an'.
'''
